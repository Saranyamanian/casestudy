...
exports.CalendarHeader = function (_a) {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { className: classes.switchHeader },
            React.createElement(IconButton_1.default, __assign({}, leftArrowButtonProps, { disabled: disablePrevMonth, onClick: selectPreviousMonth, className: classes.iconButton, "aria-label": 'Change month to previous' }), rtl ? rightArrowIcon : leftArrowIcon),
            ...
            React.createElement(IconButton_1.default, __assign({}, rightArrowButtonProps, { disabled: disableNextMonth, onClick: selectNextMonth, className: classes.iconButton, "aria-label": 'Change month to next' }), rtl ? leftArrowIcon : rightArrowIcon)),
