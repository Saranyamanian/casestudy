...
import React__default, { createContext, useMemo, createElement, useContext, useCallback, useState, useEffect, useDebugValue, useRef, cloneElement, useLayoutEffect, Fragment, Component, memo, forwardRef } from 'react';
...
var KeyboardDateInput = function KeyboardDateInput(_ref) {
  ...
  return createElement(Rifm, {
    ...
    return createElement(TextFieldComponent, _extends({
      ...
      onChange: onChange,
      variant: inputVariant,
      InputProps: _extends({}, InputProps, _defineProperty({}, "".concat(position, "Adornment"), createElement(InputAdornment, _extends({
        position: position
...
var defaultProps$1 = _extends({}, datePickerDefaultProps, {
  openTo: 'date',
  views: ['year', 'date']
});
...
var defaultProps$2 = _extends({}, dateTimePickerDefaultProps, {
  wider: true,
