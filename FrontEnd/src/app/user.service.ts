...
export class UserService {
   ...
   private userUrl = 'http://localhost:8079/user/all';
   private rootUrl = 'http://localhost:8079/user';
  ...
  addUser (user: User): Observable<User> {
    ...
    var addUrl = "http://localhost:8079/user/add";
  ...
  deleteUser(userId: number): any {
     ...
     const url = 'http://localhost:8079/user/' + userId;
